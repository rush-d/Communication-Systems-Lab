%Conventional Amplitude Modulation (AM) Simulation
...
%Calculation for Modulation Index
modIndex = Am/Ac; %Dimensionless ratio of Message Signal Amplitude and Carrier Signal Amplitude
%%
...
%Using the created function for Conventional Amplitude Modulation
modSig = convAmModulator(baseSig, Ac, Fc, Fs);
...
%Using the created function for Conventional Amplitude Demodulation
demodSig = convAmDemodulator(modSig, Am, Fm, Ac, Fc, Fs);
